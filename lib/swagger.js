...
module.exports = function (app) {
    ...
    return function (options) {
        ...
        app.use('/api-docs*', basicAuth({ challenge: true, realm: '1234', users: { 'admin': process.env.DOCS_PASSWORD || '1234' } }))

        app.use('/api-docs.json', function (req, res) {
            res.json(swaggerObject);
        });

        app.use('/api-docs', express.static(path.resolve(__dirname, '../static')));
